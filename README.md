...
local copy [ModelBLDC.pdf](ModelBLDC.pdf)). Original comparison data was sourced
from [Design Moteur.pdf](Design%20Moteur.pdf).
...
Deploy one-click to [Streamlit Community Cloud](https://streamlit.io/cloud): point
it at this repo, entrypoint `streamlit_app.py`. Source: [streamlit_app.py](streamlit_app.py).
...
## Reference frames — why raw datasheet numbers aren't comparable
